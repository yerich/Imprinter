...
<div class="list_table_toolbar">
	<a href="javascript:void(0)" class="greybutton list_table_deletebutton">Delete Selected Frontpages</a>
	<a href="edit.php?action=new" class="bluebutton">Create a new frontpage</a>
</div>
...
<table class="list_table">
	...
	<?php 
	//Get the frontpages from the database
	$filters = array("view = 'frontpage'");
	$contentpages = PageFactory::loadPages($db, array("id", "title", "created"), $filters, "title asc", 20, $start);
